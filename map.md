...
[PROYECTO ROOT]
 ...
 │    ├── app.js .......................... CONTROLADOR PRINCIPAL (State, Init, Routing)
 ...
 │    │    ├── file-importer.js ........... Gestión de PDFs e Imágenes (Pipeline)
 │    │    ├── json-importer.js ........... Carga de copias de seguridad JSON
 │    │    └── validation-modal.js ........ UI/Lógica para validación manual (OCR)
 │    │
...
```ascii
                                    [USUARIO]
                                        │
                         (Arrastra archivos PDF / IMG / JSON)
                                        │
                                        ▼
                                 [ index.html ]
                                        │
                  ...
                  ┌─────────────────────┴─────────────────────┐
                  ▼                                           ▼
         [ file-importer.js ]                        [ json-importer.js ]
        (Procesa PDF/Imágenes)                         (Procesa JSON)
                  │                                           │
      ┌───────────┴───────────┐                               │
      ▼                       ▼                               │
 [ parser.js ]          [ parser.js ]                         │
 (Mode: PDF Text)       (Mode: OCR Img)                       │
      │                       │                               │
      │                 (Tesseract.js)                        │
      ▼                       ▼                               │
 [Regex Parsing]      [Extract Raw Text]                      │
      │                       │                               │
      │                       ▼                               │
      │            [ validation-modal.js ]                    │
